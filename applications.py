...
def get_weather(city: str):
    ...
    """
    try:
        api_key = "5a91201b510f111f5203862b81ea5e58"
...
def get_news(topic: str):
    ...
    """
    try:
        api_key = "f73f477496814fcb9dc0450b686fadae"
...
def find_local_events(city: str):
    ...
    try:
        api_key = "34b9baf990258c59c8368ba00f539dfeeacc85ea7532d7ba38a907a0120f8000"
